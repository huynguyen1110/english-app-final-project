...
// err message when validating form
...
watch(() => form.password, (newValue) => {
    errMessage.value.password = passwordValidator(newValue);
});
            ...
            <div
                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Welcome E-English!
                        </div>
                    ...
                    <form @submit.prevent="handleSubmit">
                        <div class="mb-5">
                            <label for="username"
                                ...
                                name</label>
                            <InputText id="username" type="text" placeholder="User name"
                                       class="w-full md:w-[30rem] mb-2" v-model="form.username" />
                            <div>
                                <span class="font-bold text-amber-700"
                                      v-if="errMessage.username">User name is required</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div>
                                <span class="font-bold text-amber-700"
                                      v-if="errMessage.email"> {{ errMessage.email }} </span>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                            ...
                            <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary"
                                  @click="navigateToLogin">Already have an account?</span>
                        </div>
