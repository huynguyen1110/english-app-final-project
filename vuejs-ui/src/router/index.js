    ...
    routes: [
        {
            ...
            children: [
                ...
                {
                    path: '/v1/admin/news-source-management',
                    name: 'news-source-management',
                    component: () => import('@/pages/news-management/NewsSourceManagement.vue'),
                    meta: { requiresAuth: true, roles: [USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN] }
                },
                {
                ...
                {
                    path: '/v1/admin/system-news-management',
                    name: 'system-news-management',
                    component: () => import('@/pages/news-management/SystemNewsManagement.vue'),
                    meta: { requiresAuth: true, roles: [USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN] }
                },
                {
                    path: '/v1/admin/vocab-pack-management',
                    name: 'vocab-pack-management',
                    component: () => import('@/pages/vocab-management/VocabPackList.vue'),
                    meta: { requiresAuth: true, roles: [USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN] }
                },
                {
                    path: '/v1/admin/vocab-pack-management/create-package',
                    name: 'vocab-pack-management-create-package',
                    component: () => import('@/pages/vocab-management/CreatePackage.vue'),
                    meta: { requiresAuth: true, roles: [USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN] }
                },
                {
                    path: '/v1/admin/vocab-pack-management/edit-package',
                    name: 'vocab-pack-management-edit-package',
                    component: () => import('@/pages/vocab-management/CreatePackage.vue'),
                    meta: { requiresAuth: true, roles: [USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN] }
                },
                {
                    path: '/v1/admin/content-management/grammar',
                    name: 'grammar-management',
                    component: () => import('@/pages/content-management/GrammarManagement.vue'),
                    meta: { requiresAuth: true, roles: [USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN] }
                },
                {
                ...
                {
                    path: '/v1/admin/content-management/stories',
                    name: 'stories-management',
                    component: () => import('@/pages/content-management/StoriesManagement.vue'),
                    meta: { requiresAuth: true, roles: [USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN] }
                },
                {
                    path: '/v1/admin/content-management/stories/create',
                    name: 'create-story',
